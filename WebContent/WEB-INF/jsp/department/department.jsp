...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-inline" action="${pageContext.request.contextPath }/department/department" method="get">
                    ...
                    <a type="button" href="${pageContext.request.contextPath }/department/add" class="btn btn-primary" >新增</a>
                </form>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <c:forEach items="${page.rows}" var="row" varStatus="state">
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary btn-xs" onclick="editDepartment(${row.id})">修改</button>
                                    <button class="btn btn-danger btn-xs" onclick="deleteDepartment(${row.id})">删除</button>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    ...
                    <div class="col-md-12 text-right">
                        <ccc:page url="${pageContext.request.contextPath }/department/department" />
                    </div>
                    <!-- /.panel-body -->
                </div>
                <!-- /.panel -->
    ...
    <script type="text/javascript">
        ...
        function editDepartment(id) {
            window.location.href ="${pageContext.request.contextPath}/department/edit?id=" + id;
        }


        function deleteDepartment(id) {
            if(confirm('确实要删除该部门吗?')) {
                $.post("<%=basePath%>department/delete",{"id":id},function(data){
                    alert("客户删除更新成功！");
