    ...
    <div id="page-wrapper">
        ...
        <div class="modal-content" style="width: 60%">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="createPermission()">保存</button>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function createPermission() {
        ...
        $.post("<%=basePath%>permission/addPermission",$("#add_permission_form").serialize(),function(data){
            alert("新增权限成功！");
