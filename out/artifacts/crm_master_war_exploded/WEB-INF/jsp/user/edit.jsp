        ...
        <div class="modal-content" style="width: 60%">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="add_customer_form">
                    <input type="hidden" value="${queryUser.id}"  id="edit_user_id" name="id"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select	class="form-control" id="edit_customerFrom" placeholder="客户来源" name="department">
                                <option value="${queryUser.department}">${queryUser.department}</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="${queryUser.username}" class="form-control" id="edit_userName" placeholder="客户名称" name="username">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="${queryUser.staffNumber}" class="form-control" id="edit_staffNumber" placeholder="" name="staffNumber">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="${queryUser.workName}" class="form-control" id="edit_workName" placeholder="" name="workName">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="${queryUser.workNumber}" class="form-control" id="edit_workNumber" placeholder="" name="workNumber">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="${queryUser.phoneNumber}" class="form-control" id="edit_phoneNumber" placeholder="" name="phoneNumber">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="${queryUser.email}" class="form-control" id="edit_email" placeholder="" name="email">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="${queryUser.qq}"  class="form-control" id="edit_qq" placeholder="" name="qq">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select	class="form-control" id="edit_jobRank" placeholder="" name="jobRank">
                                <option value="${queryUser.jobRank}">${queryUser.jobRank}</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select	class="form-control" id="edit_jobCategory" placeholder="" name="jobCategory">
                                <option value="${queryUser.jobCategory}">${queryUser.jobCategory}</option>
                                <option value="总经理">总经理</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select	class="form-control" id="edit_staffState" placeholder="" name="staffState">
                                    <c:if test="${queryUser.staffState}"><option value="1">
                                        正常
                                    </option></c:if>
                                    <c:if test="${queryUser.staffState == false}"><option value="0">
                                        异常
                                    </option></c:if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select	class="form-control" id="edit_jobState" placeholder="" name="jobState">
                                <c:if test="${queryUser.jobState}"><option value="1">
                                    在职
                                </option></c:if>
                                <c:if test="${queryUser.jobState == false}"><option value="0">
                                    离职
                                </option></c:if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select	class="form-control" id="edit_permission" placeholder="" name="permission">
                                <option value="${queryUser.permission}">${queryUser.permission}</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="${queryUser.comment}" class="form-control" id="edit_comment" placeholder="" name="comment">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select	class="form-control" id="edit_sex" placeholder="" name="sex">
                                <option value="${queryUser.sex}">${queryUser.sex}</option>
...
<script type="text/javascript">
    ...
    function edit() {
        ...
        $.post("<%=basePath%>user/editUser",$("#add_customer_form").serialize(),function(data){
            alert("修改客户成功！");
