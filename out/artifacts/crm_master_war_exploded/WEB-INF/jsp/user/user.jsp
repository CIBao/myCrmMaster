...
<body>
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/user/list" method="get">
						...
						<a type="button" href="${pageContext.request.contextPath }/user/addUser" class="btn btn-primary" >新增</a>
					</form>
				</div>
			</div>
			<div class="row">
							...
							<tbody>
								<c:forEach items="${page.rows}" var="row">
									<tr>
										...
										<td>
											<c:if test="${row.staffState}"><font color="green">已启用</font></c:if>
											<c:if test="${row.staffState == false}"><font color="red">未启用</font></c:if>
										</td>
										<td>${row.comment}</td>
										<td>
											<button class="btn btn-primary btn-xs" onclick="queryUser(${row.id})">查看</button>
											<button class="btn btn-primary btn-xs" onclick="editUser(${row.id})">修改</button>
											<button class="btn btn-danger btn-xs" onclick="deleteUser(${row.id})">删除</button>
										</td>
									</tr>
								</c:forEach>
							</tbody>
	...
	<script type="text/javascript">
		...
		function queryUser(id) {
				window.location.href ="${pageContext.request.contextPath}/user/query?id=" + id;
		}
